        ...
        {caller == "bloglist" ? (
          post.comments[0] == undefined ? (
            ...
            <section>
              ...
              {post.comments.length > 2 ? <div>daha fazla</div> : null}
              {post.comments.length > 1 ? (
                <Comment
                  Comment={post.comments[post.comments.length - 2]}
                  key={post.comments[post.comments.length - 1] + Date.now()}
                ></Comment>
              ) : null}
              <Comment
